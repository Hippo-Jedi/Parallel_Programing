...
main( int argc, char *argv[ ] )
{
	...
	fprintf( stderr, "N,%.2lf,", megaMults );
	...
	fprintf( stderr, "S,%.2lf,", megaMults );
	double mms = megaMults;
	double speedup = mms/mmn;
	fprintf( stderr, "%.2lf,", speedup );
	...
	fprintf( stderr, "N,%.2lf,", megaMultAdds );
	mmn = megaMultAdds;
	...
	fprintf( stderr, "S,%.2lf,", megaMultAdds );
	mms = megaMultAdds;
	speedup = mms/mmn;
	fprintf( stderr, "%.2lf\n", speedup );
